'''@file                mainpage.py
   ...
   @section sec_intro1         Software Design
                               ...
                               Our program will consist of tasks position_control1, position_control2, encoder1, encoder2, solenoid_pos, and bumpswitch.
                               ...
                               The encoder tasks will be responsible for updating, reading, and setting encoder position for each motor. The solenoid
                               task will control wether the solenoid is on or off to move the pencil on and off the paper. Finally, the bumpswitch 
                               task will read when the pencil has reached the end of the leadscrew, notifying the controller the motor needs to 
                               stop or switch direction to avoid system failure. 
