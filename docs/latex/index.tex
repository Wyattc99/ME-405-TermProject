\hypertarget{index_sec_intro1}{}\doxysection{Software Design}\label{index_sec_intro1}
\begin{DoxyVerb}                        Our program will consist of tasks position_control1, position_control2, encoder1, encoder2, and HP-GL. 
...
\end{DoxyVerb}
\hypertarget{index_subsec_intro2}{}\doxysection{Task Diagram and Finite State Machines}\label{index_subsec_intro2}
\begin{DoxyVerb}                        Below is the Task Diagram of all tasks used to control the pencil position.
